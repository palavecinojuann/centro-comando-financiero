...
export const SimuladorDeudas: React.FC<SimuladorDeudasProps> = ({ deudas, onSaldosMutated }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto bg-[#161a23]/60 backdrop-blur-xl border border-white/10 p-4 md:p-8 rounded-3xl shadow-2xl text-white relative overflow-hidden mt-8">
      {/* Fondo con brillo */}
      <div className="absolute top-[-10%] right-[-10%] w-[300px] h-[300px] bg-[#06b6d4]/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 relative z-10 gap-6 border-b border-white/5 pb-8">
        <div>
          <p className="text-[10px] font-sans tracking-[0.3em] uppercase text-[#06B6D4] font-black mb-2">
             ...
             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
               {analisisIA.acciones.map((accion, idx) => (
                 <div key={idx} className="bg-black/30 border border-white/10 p-5 rounded-2xl group hover:bg-black/50 transition-colors">
                    ...
                    <p className="text-[11px] text-[#06b6d4] font-bold uppercase tracking-wider mt-3 border-t border-white/5 pt-3 mb-1">Impacto Táctico:</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 relative z-10">
        ...
        <div className="lg:col-span-1 space-y-8">
          ...
          {resultadoBolaDeNieve.capitalBloqueadoParaProximoMes > 0 && (
            <div className="group bg-gradient-to-br from-[#06b6d4]/15 to-transparent border border-[#06b6d4]/30 p-6 rounded-3xl text-[#06b6d4] shadow-[0_10px_20px_rgba(6,182,212,0.05)]">
              ...
              <p className="text-[11px] font-medium text-[#06b6d4]/80 mt-3 leading-relaxed font-sans italic">
                ...
                <div 
                  ...
                  className={`group p-6 rounded-2xl border transition-all duration-500 hover:translate-x-1 ${
                    esExtinguida 
                      ...
                      : 'bg-[#161A23]/80 border-white/10 shadow-lg hover:border-[#06b6d4]/40 backdrop-blur-md'
                  }`}
                >
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
                    ...
                    <div className="text-left sm:text-right font-sans">
                      ...
                      <p className={`text-xl font-serif font-bold tracking-tighter ${esExtinguida ? 'text-[#06b6d4]' : 'text-[#F1C40F]'}`}>
                  ...
                  {!esExtinguida && ejecucion && (
                    <div className="mt-4 pt-4 border-t border-white/5 flex justify-between items-center text-[10px] font-sans italic opacity-90">
                      ...
                      <span className="font-sans bg-[#06b6d4]/10 px-4 py-2 rounded-xl text-[#06b6d4] font-black border border-[#06b6d4]/20 shadow-[0_0_15px_rgba(6,182,212,0.1)]">
